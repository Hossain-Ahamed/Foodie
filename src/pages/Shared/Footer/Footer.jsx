                ...
                <div className="mx-auto max-w-md">
                    ...
                    <form className="mt-6">
                        <div className="relative max-w-lg">
                            ...
                            <input
                                className="w-full rounded-full border-gray-200 p-4 pe-32 text-sm font-medium bg-yellow-50"
                                id="email"
                                type="email"
                            ...
                            <button
                                className="absolute end-1 top-1/2 -translate-y-1/2 rounded-full bg-red-500 px-5 py-3 text-sm font-medium text-white transition hover:bg-red-600"
                            >
                                Subscribe
                            </button>
                        </div>
